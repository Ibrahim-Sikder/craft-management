...
function SunaniDailyReportForm({ studentName, reportDate, month, id }: any) {
    ...
    const { data: singleData, isLoading: singleReportLoading } = useGetSingleSunaniReportQuery(id)
    ...
    return (
        <CraftForm onSubmit={handleSubmit} defaultValues={defaultValue}>
            <Card sx={{ boxShadow: "none", "@media print": { boxShadow: "none", border: 0 } }}>
                ...
                <ReportHeader title=" Shunani Hifz Students Daily Report" subtitleBangla="শুনানী হিফজ শিক্ষার্থীদের দৈনিক রিপোর্ট" />
                ...
                <CardContent sx={{ p: 3 }}>
                    ...
                    <Box sx={{ width: '100%', overflow: 'auto' }}>
                        <TableContainer component={Paper} sx={{ minWidth: 1200, '@media print': { minWidth: '100%' } }}>
                            ...
                            >
                                <TableHead>
                                    <ReportTableRow  col1Label='  সকালের পড়া' col2Label='  রাতের পড়া' col3Label='    পেছনের পড়া' />
                                </TableHead>
                                <ReportTableBody />
                            </Table>
                        </TableContainer>
