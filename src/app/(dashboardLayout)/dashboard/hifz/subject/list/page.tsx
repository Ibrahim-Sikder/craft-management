...
export default function HifzSubjectManagementPage() {
  ...
  return (
    <div
      className="flex-grow rounded-4xl min-h-screen"
      style={{
                ...
                <Box className="grid grid-cols-12 gap-4 items-center">
                  ...
                  <Box className="col-span-12 md:col-span-7 flex justify-end">
                    <Box className="flex items-center text-sm text-green-700 bg-green-50 px-3 py-2 rounded-lg">
                      ...
                      {filteredSubjects.length} Hifz subject
                          ...
                          <TableRow>
                            ...
                            >
                              <Box className="text-center">
                                ...
                                />
                                <h6 className="text-xl font-medium text-gray-500 mb-2">
                                  No Hifz subjects found
                                </h6>
                                <p className="text-gray-400 max-w-md mx-auto">
                                  Try adjusting your search query or add a new
                                  Hifz subject to get started.
                                </p>
                              </Box>
                            </TableCell>
                          </TableRow>
      ...
      >
        ...
        <DialogContent sx={{ padding: 3 }}>
          <p className="text-gray-700">
            Are you sure you want to delete the Hifz subject &quot;
            {selectedSubject?.name}&quot;? This action cannot be undOnend will
