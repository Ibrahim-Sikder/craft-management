  ...
  <Chip
    ...
    sx={{
      backgroundColor: alpha(
        departmentColors[label] || departmentColors["Not Specified"],
        0.1,
      ),
            ...
            <Box>
              ...
              >
                <Box>
                  ...
                  <Typography
                    variant="body1"
                    sx={{ color: islamicColors.lightText }}
                  >
              ...
              <StyledCard sx={{ mb: 4, overflow: "hidden" }}>
                <Box
                  sx={{
                    p: 3,
                    borderBottom: `1px solid ${alpha(islamicColors.primary, 0.1)}`,
                  }}
                >
                        ...
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position="start">
                              <SearchIcon
                                sx={{
                                  color: alpha(islamicColors.primary, 0.7),
                                }}
                              />
                            </InputAdornment>
                          ),
                ...
                {isLoading ? (
                  ...
                  <Box sx={{ textAlign: "center", p: 6 }}>
                    <School
                      sx={{
                        fontSize: 64,
                        color: alpha(islamicColors.primary, 0.3),
                        mb: 2,
                      }}
                    />
                    <Typography
                      variant="h6"
                      sx={{ color: islamicColors.lightText, mb: 1 }}
                    >
                      No classes found
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ color: alpha(islamicColors.lightText, 0.7), mb: 3 }}
                    >
                      {searchTerm
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>
          <Typography
            variant="h6"
            component="div"
            sx={{ fontWeight: 600, color: islamicColors.primary }}
          >
            Delete Class
          </Typography>
        </DialogTitle>
