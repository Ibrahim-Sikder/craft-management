...
//   // Get selected students and teachers IDs
//   const getSelectedPersonsByType = (type: PersonType): string[] => {
//     return persons.filter((person) => person.type === type && selectedPersons[person.id]).map((person) => person.id)
//   }

//   // Handle save - Updated to match the validation schema
...
//     const selectedStudents = getSelectedPersonsByType("student")
//     const selectedTeachers = getSelectedPersonsByType("teacher")
...
//     // Get the selected meal type (using the first one if multiple are selected)
//     const selectedMealType =
//       selectedMealTypes.length > 0 ? mealTypeMapping[selectedMealTypes[0] as keyof typeof mealTypeMapping] : null
