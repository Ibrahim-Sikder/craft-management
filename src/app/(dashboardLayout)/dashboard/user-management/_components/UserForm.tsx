              ...
              <Box
                sx={{
                  ...
                  "&::after": {
                    ...
                    height: "4px",
                    background:
                      "linear-gradient(90deg, #4F0187, #9333EA, #4F0187)",
                    borderRadius: "2px",
                    opacity: 0.7,
                  },
                }}
              >
                <Box>
                  ...
                  <Typography variant="body1" color="text.secondary">
                    Create a new user account with specific roles and
                    permissions
                  </Typography>
                </Box>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        boxShadow:
                          activeStep === index
                            ? "0px 8px 15px rgba(79, 1, 135, 0.25)"
                            : "none",
                        transition: "all 0.3s ease",
                      }}
                    >
                    ...
                    <Typography
                      ...
                      sx={{
                        ...
                        color:
                          activeStep === index ? "#4F0187" : "text.secondary",
                      }}
                    >
                      {step}
                    </Typography>
                    ...
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12}>
                        ...
                        >
                          ...
                          <Typography variant="body2" color="text.secondary">
                            For security, passwords should include a mix of
