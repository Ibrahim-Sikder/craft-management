...
//       const normalizedItemClass = String(item.className || "").trim().toLowerCase();
      
//       if (normalizedItemClass === normalizedTargetClass) {
...
//   const calculateAvailableAdvance = (feeIndex: number, itemIndex: number) => {
//     const fees = watch("fees") || [];
//     let allocated = 0;

//     fees.forEach((fee: any, fIndex: number) => {
//       if (fIndex !== feeIndex && fee.feeItems) {
//         fee.feeItems.forEach((item: any) => {
//           if (item.advanceAmount) {
//             allocated += parseFloat(item.advanceAmount) || 0;
//           }
//         });
//       }
//     });

//     const currentFee = fees[feeIndex];
//     if (currentFee && currentFee.feeItems) {
//       currentFee.feeItems.forEach((item: any, iIndex: number) => {
//         if (iIndex !== itemIndex && item.advanceAmount) {
//           allocated += parseFloat(item.advanceAmount) || 0;
//         }
//       });
//     }
...
//   // --- FIX: Robust Handle Item Field Change ---
...
//         // Normalize inputs
//         const normalizedTargetClass = String(classNameStr || "").trim().toLowerCase();
//         // Handle both string (freeSolo) and object (select) values
...
//           if (String(fType).toLowerCase().includes('monthly')) {
...
//       discountBase = totalFees;
//     } else {
//       discountBase = monthlyFeeAmount > 0 ? monthlyFeeAmount : totalFees;
//     }
...
//     if (discountType === 'percentage') {
//       calculatedDiscount = (discountBase * amount) / 100;
//     } else {
//       calculatedDiscount = amount;
//     }

//     if (calculatedDiscount > totalFees) {
//       calculatedDiscount = totalFees;
//     }

//     const netPayable = totalFees - calculatedDiscount;

//     return { totalFees, monthlyFeeAmount, calculatedDiscount, netPayable };
//   };
...
//                             const availableAdvance = calculateAvailableAdvance(index, itemIndex);
//                             const maxAdvance = Math.min(availableAdvance, item.amount || 0);
...
//                   <Typography variant="overline" color="error.main" fontWeight="bold" sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
//                     <LocalOffer sx={{ fontSize: 16, mr: 1 }} /> DISCOUNT
//                   </Typography>
...
//                         size="small"
//                         InputProps={{
//                           endAdornment: discountType === 'percentage' ? <InputAdornment position="end">%</InputAdornment> : <InputAdornment position="end">৳</InputAdornment>
//                         }}
//                       />
//                     </Grid>
//                   </Grid>
...
//                       ? `Applied on Total Fees (৳${summary.totalFees})`
//                       : `Applied on Monthly Fee (৳${summary.monthlyFeeAmount})`}
//                   </Typography>
//                 </Grid>
...
//         // Find the object in typeOptions to ensure consistent object reference if possible, 
//         // or just create a standard object structure
...
//       if (totalAdvanceUsed > studentAdvanceBalance) {
//         toast.error("Advance balance insufficient!");
//         setSubmitting(false);
//         return;
//       }
...
//         advanceBalance: studentAdvanceBalance - totalAdvanceUsed,
//       };
