...
const StudentList = () => {
  ...
  const { classOptions, sectionData } = useAcademicOption();
  ...
  const filteredStudents = students.filter((student: any) => {
    ...
    if (
      filters.className &&
      String(filters.className) !== String(student.className)
    ) {
      return false;
    }
    ...
    if (
      filters.section &&
      String(filters.section) !== String(student.section)
    ) {
      return false;
    }
    ...
    if (
      filters.studentType &&
      String(filters.studentType) !== String(student.studentType)
    ) {
      return false;
    }
                ...
                <FormControl fullWidth size="small">
                  ...
                  >
                    ...
                    {classOptions.map((cls: any, i: number) => (
                      <MenuItem
                        key={i}
                        value={cls.className || cls.name || cls}
                      >
          ...
          >
            <Table sx={{ minWidth: { xs: 0, md: 650 } }}>
              <TableHead>
                ...
                >
                  <TableCell
                    sx={{ fontWeight: "bold", color: customColors.primary }}
                  >
                    ID
                  </TableCell>
                  <TableCell
                    ...
                    >
                      ...
                      <TableCell sx={{}}>
                        <Chip
                          ...
                          sx={{
                            bgcolor: alpha(
                              getStudentTypeColor(student.studentType),
                              0.1
                            ),
                      ...
                      <TableCell>
                        <Box sx={{ display: "flex" }}>
                          <Tooltip title="View Details">
                            <IconButton
                              component={Link}
                              href={`/dashboard/student/profile/${student._id}`}
                              size="small"
                              sx={{
                          ...
                          <Tooltip title="Edit Student">
                            <IconButton
                              component={Link}
                              href={`/dashboard/student/update/${student._id}`}
                              size="small"
                              sx={{
                          ...
                          <Tooltip title="Delete Student">
                            <IconButton
                              ...
                              sx={{
                                ...
                                "&:hover": {
                                  bgcolor: alpha(customColors.error, 0.1),
                                },
                              }}
                            >
