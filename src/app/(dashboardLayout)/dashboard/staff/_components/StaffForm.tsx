    ...
    if (!data.name) {
      ...
      try {
        const monthlySalaryNum = data.monthlySalary
          ...
          : undefined;
        const staffSerialNum = data.teacherSerial
        ...
        >
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: "#1b5e20" }}>
              Registering a Staff is the first step in the onboarding process.
              After registration, you can manage the Staff's professional
              records, attendance, and salary payments. Make sure to fill in all
              required fields marked with an asterisk (*) for successful
              registration.
            </Typography>
          </Box>
        </Paper>
