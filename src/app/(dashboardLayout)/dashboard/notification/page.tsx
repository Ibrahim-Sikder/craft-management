  ...
  const initialNotifications = useMemo(
    () => [
      ...
      },
      {
        ...
        message: "Monthly fee payment is due in 3 days. Please pay to avoid late charges.",
      ...
      },
      {
        ...
        message: "Tomorrow's English class has been moved to 2nd period.",
      ...
      },
      {
        ...
        message: "Mid-term examination results are now available in the student portal.",
