...
} from "@/redux/api/amparaDailyReportApi";
...
function AmparaDailyReport({ studentName, reportDate, month, id }: any) {
  ...
  const { data: singleData, isLoading: singleReportLoading } =
    useGetSingleAmparaReportQuery(id);
  ...
  return (
    <CraftForm onSubmit={handleSubmit} defaultValues={defaultValue}>
      ...
      >
        <ReportHeader
          title="Ampara Students Daily Report"
          subtitleBangla="আমপারা ছাত্রদের দৈনিক রিপোর্ট"
        />
          ...
          <Box sx={{ width: "100%", overflow: "auto" }}>
            ...
            >
              <Table size="small" sx={tableStyle}>
                <TableHead>
                  <ReportTableRow
                    col1Label=" Morning (সকাল)"
                    col2Label="	Afternoon (দুপুর)"
                    col3Label=" 	Night (রাত)"
                  />
                </TableHead>
                <ReportTableBody />
