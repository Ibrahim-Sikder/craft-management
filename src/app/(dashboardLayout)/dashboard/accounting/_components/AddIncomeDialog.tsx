...
export default function AddIncomeModal({
  ...
  const { data: singleIncome, isLoading: singleIncomeLoading } =
  ...
  const handleAddIncomeItem = () => {
    ...
    setIncomeItems((prev) => [
      ...prev,
      { id: newId, source: "", description: "", amount: "" },
    ]);
  };
  ...
  const handleSubmit = async (data: any) => {
    ...
    const totalAmount = cleanedIncomeItems.reduce(
  ...
  const defaultValues =
    id && singleIncome?.data
      ? {
          ...
          incomeItems: singleIncome.data.incomeItems.map(
