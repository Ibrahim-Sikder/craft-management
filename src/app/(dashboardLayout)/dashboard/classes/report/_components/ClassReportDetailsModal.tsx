      ...
      <DialogContent sx={{ py: 4 }}>
        ...
        <Grid container spacing={3} mb={4}>
          ...
          <Grid item xs={6} md={3}>
            <MetricCard
              ...
              color={
                studentEvaluation.parentSignature
                  ? statusColors.present
                  : statusColors.absent
              }
            />
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <SectionCard icon={<AssignmentIcon />} title="Academic Evaluation">
              <DetailItem
          ...
          <Grid item xs={12} md={6}>
            <SectionCard icon={<CommentIcon />} title="Comments & Notes">
              <Paper
                elevation={0}
                sx={{
                  p: 2,
        ...
        <Box mt={4}>
          <SectionCard icon={<SchoolIcon />} title="Class Curriculum" fullWidth>
            <Grid container spacing={3}>
              {/* Today's Lesson */}
              <Grid item xs={12} md={6}>
